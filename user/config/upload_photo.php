...
$data = getData();
  ...
  $folder=$_SERVER['DOCUMENT_ROOT']."/v3/assets/user_doc/";
  ...
  if (move_uploaded_file($file_loc,$folder.$final_file)) {
    ...
    $answer_upload_sql ="UPDATE users Set doc ='user_doc/$final_file' WHERE email= '$check_existing_email';";
    $approved = "doc_upload_only";
    $change_approved ="UPDATE users SET approved='$approved' WHERE unique_id_php ='$id';";


    mysqli_query($connect, $answer_upload_sql);
    mysqli_query($connect, $change_approved);
