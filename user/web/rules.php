  ...
  $output_list='';
    ...
    $val= pass_openssl_2_enc($list_row["id"]);
		$output_list .= '
			<tr>
				<td>'.$i.'</td>
				<td class="text-capitalize">'.$list_row["rule_name"].'</td>
				<td class="text-capitalize">'.$list_row["audience"].'</td>
...
<body>
  ...
  <div class="data_show">
    ...
    <div id="settings_list_output">
        <h2 class="text-center"style="font-weight: bold;">Add roles</h2>
            ...
            <form autocomplete="off">
              <div class="modal-body">
                ...
                <div class="text-capitalize">
                  <p>Role Name: <span id="name"></span></p>
