...
define("PAGE_NAME","Cell Block Management");
  ...
  $output_list='';
    ...
    $remaining = $n_max -$booked;
		$output_list .= '
			<tr>
				<td>'.$i.'</td>
				<td class="text-capitalize">'.$list_row["cell_no"].'</td>
				<td class="text-capitalize">'.$list_row["max"].'</td>
				<td class="text-capitalize">'.$list_row["booked"].'</td>
				<td class="text-capitalize">'.$remaining.'</td>
...
if (isset($_POST['add_rule_submit'])){
    ...
    $add_rule_audience = mysqli_real_escape_string($connect, $_POST['add_audience']);
      ...
      $firstsql = "SELECT *  FROM cell_data WHERE cell_no ='$add_rule_name';";
      $result = mysqli_query($connect, $firstsql);
      $row = mysqli_fetch_array($result);
      if(mysqli_num_rows($result) == 1){
        $msg = "Already present";
      }else{
        $insertsql=  " INSERT INTO cell_data(cell_no, max) VALUES ('$add_rule_name','$add_rule_audience')";
...
<body>
  ...
  <div class="data_show">
    ...
    <div id="settings_list_output">
        <h2 class="text-center"style="font-weight: bold;">Cell Block Management</h2>
              ...
              <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Add Cell</h5>
                  ...
                  <div class="form-group">
                         <label for="add_rule_name">Enter Cell name</label>
                         <input type="text" class="form-control" name="add_rule_name" id="add_rule_name" aria-describedby="helpId" placeholder="" required>
                       </div>
                       <div class="form-group">
                          <label for="add_audience">MAx Entery</label>
                          <input type="number" class="form-control" name="add_audience" id="add_audience" aria-describedby="helpId" placeholder="" required>
                       </div>
            ...
            <form autocomplete="off">
              <div class="modal-body">
                ...
                <div class="text-capitalize">
                  <p>Cell Name: <span id="name"></span></p>
                  <p>MAx: <span id="max"></span></p>
                  <p>Booked: <span id="booked"></span></p>
                </div>
                <div class="p-2">
